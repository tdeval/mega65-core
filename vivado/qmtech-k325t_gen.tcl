...
set script_file "qmtech-k325t.tcl"
...
# Create project
create_project -force ${project_name} vivado/ -part xc7k325tffg676-1
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/vhdl/sdcardio_mx25l.vhdl"]"\
 ...
 "[file normalize "$origin_dir/src/vhdl/qmtech-k325t.vhdl"]"\
...
set file "vhdl/qmtech-k325t.vhdl"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "vhdl/sdcardio_mx25l.vhdl"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "vhdl/audio_out_test_tone.vhdl"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "vhdl/i2c_controller.vhdl"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "[file normalize "$origin_dir/src/vhdl/qmtech-k325t.xdc"]"
set file_imported [add_files -fileset constrs_1 $file]
set file "vhdl/qmtech-k325t.xdc"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7k325tffg676-1 -flow {Vivado Synthesis 2017} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7k325tffg676-1 -flow {Vivado Implementation 2017} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
