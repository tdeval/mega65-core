...
set script_file "qmtech-a200t.tcl"
...
# Create project
create_project -force ${project_name} vivado/ -part xc7a200tfbg676-1
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/vhdl/icape2sim.vhdl"]"\
 ...
 "[file normalize "$origin_dir/src/vhdl/qmtech-a200t.vhdl"]"\
...
set file "vhdl/qmtech-a200t.vhdl"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "[file normalize "$origin_dir/src/vhdl/qmtech-a200t.xdc"]"
set file_imported [add_files -fileset constrs_1 $file]
set file "vhdl/qmtech-a200t.xdc"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a200tfbg676-1 -flow {Vivado Synthesis 2017} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a200tfbg676-1 -flow {Vivado Implementation 2017} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
